...
const localAuth = {
  ...
  init() {
    ...
    this.CLIENT_ID = 'Ov23ligdD15X72rM6QAg';
    this.CLIENT_SECRET = '40624ca43ad3ff8376358b609bfe79327bbc9c63';
...
if (window.location.host === 'github.com') {
  chrome.storage.local.get('pipe_codehub', data => {
    if (data && data.pipe_codehub) {
